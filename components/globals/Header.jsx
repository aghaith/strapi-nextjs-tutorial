...
import SiteBanner from '../../public/images/site-banner.jpg';
import MeAvatar from '../../public/images/me-avatar.png';

const profile = {
  name: 'Abbas Ghaith',
  role: 'Front-end Development Engineer',
  companyURL: 'https://india.superfuture.asia/',
  companyName: 'Super Future',
  email: 'abbasg@superfuture.world',
  message:
    "Hey there, If you ever need my services on a similar project, I'd love to help!",
  callToActionURL: 'https://www.linkedin.com/in/abbas-ghaith-92a76611a',
  callToActionMessage: 'Book a Call With Me',
  profileImage: MeAvatar,
  coverImage: SiteBanner,
};
